var levels = [
    ...
    {
        helpTitle: "Selectionnez tous les citrons de la table",
        selectorName: "Selecteur de type",
        doThis: "Selectionnez les citrons",
        selector: "citron",
        syntax: "A",
        help: "Sélectionnez tous les éléments de type <strong>A</strong>.",
        examples: [
            '<strong>span</strong> selects all <tag>span</tag> elements.',
            '<strong>ul</strong> selects all <tag>ul</tag> elements.',
        ],
        boardMarkup: `
    <citron/>
    <plate/>
